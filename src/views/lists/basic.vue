    ...
    <el-header height="40px">
      <div style="overflow: hidden;">
        <el-tooltip v-if="allowCreate" content="创建新条目">
          <el-button round plain icon="el-icon-plus" size="small" type="primary" style="float: right;" @click="onAdd"></el-button>
        </el-tooltip>
      </div>
    </el-header>
    <el-main>
    <div class="basic-table">
      <el-table style="width: 100%;" :data="items" v-if="items && items.length" @row-click="detail">
        <slot></slot>
      ...
      <model-drawer :model="model" :id="selected" :mode="mode" @close="onClose" />
      </div>
    </el-main>
    <el-footer>
